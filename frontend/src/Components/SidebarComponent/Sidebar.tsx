...
export const Sidebar=()=>{
    ...
    return (
        <div className={`bg-white z-10 border border-primary rounded-tr-[32px] bottom-0 left-0 absolute lg:h-full lg:w-[450px] ${!sidebar?"invisible lg:visible":"w-[270px] h-[560px] sm:w-[500px] sm:h-[765px] "}`}>
